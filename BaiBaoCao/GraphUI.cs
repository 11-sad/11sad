...
namespace BaiBaoCao
{
    partial class GraphUI : Control
    {
        ...
        public List<Node> Node { get; internal set; }
        public List<Edge> Edge { get; internal set; }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            foreach (var item in _edges)
            {
                ...
                DrawEdge(g, item, p1, p2, ctl1.Width / 2, ctl2.Width / 2);
            }
            if (_ball != null)
        ...
        void DrawEdge(Graphics g, Edge item, PointF p1, PointF p2, int radius1, int radius2)
        {
